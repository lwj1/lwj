...
<body>
<div class="item">
    <form action="/addtraining" id="a2">
        <table>

            <div class="tit">培训添加</div>
            <div class="itemli"><span>培训名称</span><input name="name"></div>
            <div class="itemli"><span>培训时长</span><input name="duration"></div>
            <div class="clear"></div>
